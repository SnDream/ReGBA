...
#ifdef DROP_CODE_CACHE_PART
#define READONLY_CODE_CACHE_DROP_OFFSET (3 * 1024 * 1024)
#define WRITABLE_CODE_CACHE_DROP_OFFSET (1 *  512 * 1024)
#else
#define READONLY_CODE_CACHE_DROP_OFFSET 0
#define WRITABLE_CODE_CACHE_DROP_OFFSET 0
#endif
#define READONLY_CODE_CACHE_DROP_SIZE   (READONLY_CODE_CACHE_SIZE - READONLY_CODE_CACHE_DROP_OFFSET)
#define WRITABLE_CODE_CACHE_DROP_SIZE   (WRITABLE_CODE_CACHE_SIZE - WRITABLE_CODE_CACHE_DROP_OFFSET)
#endif
